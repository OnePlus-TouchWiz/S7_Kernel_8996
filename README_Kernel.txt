...
1. How to Build
	...
	- edit Makefile
		...
		$ make -C $(pwd) O=$(pwd)/out KCFLAGS=-mno-android VARIANT_DEFCONFIG=msm8996_sec_hero2qlte_chnzc_defconfig msm8996_sec_defconfig SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig TIMA_DEFCONFIG=tima_defconfig DMVERITY_DEFCONFIG=dmverity_defconfig
